const phases = [
  {
    ...
    timeframe: "Today",
    body: "Fill out the 2-minute form. We'll review your current site, online presence, and top competitors. You'll get a plain-English breakdown of exactly where you're bleeding leads.",
    color: "var(--gg-accent)",
  ...
  },
  {
    ...
    timeframe: "Day 1",
    body: "Send your assets and complete the quick verification call. Once everything is confirmed, the build begins and your site is live within 72 hours.",
    color: "#a78bfa",
  ...
  },
  {
    ...
    body: "Site goes live on your domain. Listings submitted. Presence Management Plan activates. Referral Engine configured. Your online presence starts working around the clock — and your happy customers start sending you new ones.",
    color: "#f59e0b",
