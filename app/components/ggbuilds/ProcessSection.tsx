const phases = [
  ...
  },
  {
    ...
    timeframe: "Day 1",
    body: "Send us your logo, 3–5 photos of your work, and a quick rundown of your services. That's it. Build kicks off the same day assets land.",
    color: "#a78bfa",
  ...
  },
  {
    ...
    timeframe: "Day 2–3",
    body: "We send you a live preview link. You review on your phone. We fix anything that needs fixing — included in the build, no charge.",
    color: "var(--gg-green)",
