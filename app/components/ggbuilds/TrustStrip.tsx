...
const items: StripItem[] = [
  ...
  },
  {
    icon: (
      <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
        <path d="M12 4H4a1.5 1.5 0 00-1.5 1.5v6A1.5 1.5 0 004 13h1l1.5 2 1.5-2h4a1.5 1.5 0 001.5-1.5v-6A1.5 1.5 0 0012 4z" stroke="currentColor" strokeWidth="1.3" strokeLinejoin="round"/>
        <path d="M6 7.5h4M6 9.5h3" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
      </svg>
    ),
    text: "Missed Call Texts",
  },
  {
    icon: (
      <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
