    ...
    <div style={{ background: "var(--gg-bg)", minHeight: "100vh", padding: "32px 24px 64px" }}>
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        <section style={sectionStyle}>
          ...
          <p style={pStyle}>
            Calls From Clicks (&quot;we,&quot; &quot;us,&quot; &quot;our&quot;) provides website development, local presence setup and refinement, marketing automation setup, and related services.
          </p>
          <p style={pStyle}>
            Our local presence setup includes submission and refinement of your business on: Google Business Profile, Apple Maps, Yelp, Angi, Facebook, Yellow Pages, and Trustpilot or Houzz when relevant to your industry. We do not control verification, approval, or listing policies of these third-party platforms.
          </p>
          <p style={pStyle}>
